    ...
    <body>
        ...
        <div class="header">
            ...
            <div class="header__right">
                ...
                <form id="form-log-out" action="{{ route('logout') }}" method="POST">
                    @csrf
                </form>
                <a class="dropdown-item" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('form-log-out').submit();">
                    ...
                    <div class="messageSender__top">
                        ...
                        <form action="{{ route('store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="messageSender__bottom">
                                ...
                                <div class="messageSender__option">
                                    <input type="file" name="image_video" accept="image/*, video/*">
                                </div>
                                ...
                                <button class="messageSender__button" type="submit">
                    ...
                    <div class="post">
                        <div class="post__top">
                            ...
                            <div class="post__topInfo">
                                ...
                                <p>{{ $post->created_at->format('d F Y \a\\t H:i') }}</p>
                            </div>
                        </div>
                        ...
                        @if ($post->image_video)
                            <div class="post__image">
                                <img 
                                    src="{{ Str::startsWith($post->image_video, ['http', 'https']) ? $post->image_video : asset('storage/' . $post->image_video) }}" 
                                    alt="Uploaded Image"
                                />
                            </div>
                        @endif

                        <p>Like: {{ $post->countLike() }}</p>
                        <p>Comments: {{ $post->countComment() }}</p>
                        <p>Shares: {{ $post->countShare() }}</p>
